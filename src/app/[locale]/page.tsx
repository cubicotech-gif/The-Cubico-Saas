...
export default async function HomePage() {
  const [settings, homeServices, media] = await Promise.all([
    getSiteSettings(),
    getHomeServices(),
    getMediaAssets(),
  ]);
  ...
  return (
    <>
      ...
      <main className="h-screen overflow-y-auto snap-y snap-mandatory">
        {/* Screen 1: Hero + Visual + Services — everything at one glance */}
        <HeroWithServices settings={settings} services={homeServices} media={media} />
